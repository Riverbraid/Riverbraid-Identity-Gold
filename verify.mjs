...
const output = {
  ...
  version: "1.0.0",
  repo: "Riverbraid-Identity-Gold",
  ring: 1,
  petal: "Identity-Gold",
  invariant: "IDENTITY_STATIONARY",
...
if (output.status !== "VERIFIED") {
  console.error("IDENTITY_GOLD_VERIFICATION_FAILED");
  process.exit(1);
}
console.log("IDENTITY_GOLD_VERIFICATION_SUCCESS");
